...
$.fn.htmlbox=function(options){
	...
	var d={
		...
		idir:"../compartida/libreria/plugins/HtmlBox/images/",// HtmlBox Image Directory, This is needed for the images to work
		...
		for(var k=0;k<d.toolbars.length;k++){
			...
			for(var i=0;i<(toolbar.length);i++){
	            ...
	            // END: Custom button
				    ...
				    h += "<td valign='middle' align='center'><select id='"+d.id+"_highlight' onchange='global_hb[\""+d.id+"\"].cmd(\"backcolor\",this.options[this.selectedIndex].value)' style='font-size:12px;'><option value='' selected>-DESTACAR-</option>";
				    ...
				    h += "<td valign='middle' align='center'><select id='"+d.id+"_syntax' onchange='global_hb[\""+d.id+"\"].cmd(\"syntax\",this.options[this.selectedIndex].value);this.options[0].selected=\"true\";' style='font-size:12px;'><option value='' selected>-SINTAXIS-</option>";
				...
				// Commands
				//var cmds = {"about":"About","bold":"Negrita","center":"Centrar","code":"View Code","copy":"Copiar","cut":"Cortar","hr":"Insert Line","link":"Insertar Link","image":"Insert Image","indent":"Disminuir Sangria","italic":"Cursiva","justify":"Justificar","left":"Izquierda","ol":"Numeraci&oacute;n","outdent":"Aumentar Sangria","paragraph":"Insertar Paragrafo","paste":"Pegar","quote":"Quote","redo":"Rehacer","removeformat":"Remove Format","right":"Derecha","strike":"Tachado","striptags":"Strip Tags","sub":"Sub&iacute;ndice","sup":"Super&iacute;ndice","ul":"Vi&ntilde;etas","underline":"Subrayado","undo":"Deshacer","unlink":"Remover Link"};
				var cmds = {"bold":"Negrita","center":"Centrar","copy":"Copiar","cut":"Cortar","hr":"Insertar Linea","link":"Insertar Link","indent":"Disminuir Sangria","italic":"Cursiva","justify":"Justificar","left":"Izquierda","ol":"Numeraci&oacute;n","outdent":"Aumentar Sangria","paragraph":"Insertar Paragrafo","paste":"Pegar","redo":"Rehacer","removeformat":"Remover Formato","right":"Derecha","strike":"Tachado","sub":"Sub&iacute;ndice","sup":"Super&iacute;ndice","ul":"Vi&ntilde;etas","underline":"Subrayado","undo":"Deshacer","unlink":"Remover Link"};
	...
	this._init = function(is_init){
		...
		if(d.skin==="blue"){
			hb_border = "1px solid #930A10";
			hb_background = "#FFFFFF";//#B11A1A
			tb_border = "1px solid #930A10";
		}
        if(d.skin==="red"){
